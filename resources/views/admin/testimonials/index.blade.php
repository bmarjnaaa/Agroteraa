    ...
    <table class="w-full border-collapse border border-gray-300">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border border-gray-300 p-2">
                    <a href="{{ route('admin.testimonials.edit', $testimonial) }}" class="text-blue-600 mr-2">Edit</a>
                    <form action="{{ route('admin.testimonials.destroy', $testimonial) }}" method="POST" class="inline">
                        @csrf @method('DELETE')
                        <button type="submit" class="text-red-600" onclick="return confirm('Yakin hapus testimonial ini?')">Hapus</button>
                    </form>
                </td>
            </tr>
            @endforeach
